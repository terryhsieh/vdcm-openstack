...
glance -A $TOKEN add name="ubuntu-lucid" is_public=true container_format=ami disk_format=ami kernel_id=$KERNEL_ID ramdisk_id=$RAMDISK_ID < ./VMImages/lucid-server-cloudimg-amd64.img
