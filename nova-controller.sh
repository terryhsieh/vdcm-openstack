...
apt-get install -y --force-yes nova-api nova-scheduler nova-objectstore nova-vncproxy nova-ajax-console-proxy openstackx python-mysqldb mysql-client curl
